<div class="flex gap-x-4">
	...
	<a href="https://github.com/jonichi16" target="_blank">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 fill-current | md:w-9"
	...
	<a href="https://www.linkedin.com/in/jonichi16/" target="_blank">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 fill-current | md:w-9"
	...
	<a href="https://www.instagram.com/jonichi16/" target="_blank">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 fill-current | md:w-9"
