...
<div class="flex gap-x-4 {center ? 'justify-center' : null}">
	<a href="mailto:jonichi16@gmail.com" class="hover:animate-wiggle">
	...
	<a href="https://github.com/jonichi16" target="_blank" class="hover:animate-wiggle">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 fill-current | md:w-9"
	...
	<a href="https://www.linkedin.com/in/jonichi16/" target="_blank" class="hover:animate-wiggle">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 fill-current | md:w-9"
	...
	<a href="https://www.instagram.com/jonichi16/" target="_blank" class="hover:animate-wiggle">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 fill-current | md:w-9"
